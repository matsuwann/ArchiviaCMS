                                        ...
                                        <div className="flex justify-between items-start">
                                            ...
                                            <div className="flex-shrink-0 flex flex-col gap-2">
                                                <button 
                                                    ...
                                                    className="px-3 py-2 bg-white border border-gray-300 text-gray-700 text-sm font-medium rounded-md hover:bg-gray-50 shadow-sm flex items-center gap-1"
                                                >
                                                ...
                                                {doc.filepath && (
                                                    <a
                                                        ...
                                                        className="px-3 py-2 bg-green-600 border border-transparent text-white text-sm font-medium rounded-md hover:bg-green-700 shadow-sm flex items-center gap-1 justify-center"
                                                    >
                                                        PDF
                                                    </a>
                                                )}
